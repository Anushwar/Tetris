...
let tetrominos = [];
let tetrominosColors = ['purple', 'cyan' , 'blue', 'orange', 'yellow', 'green', 'red'];
...
function CreateTetromino(){
    ...
    currTetrominoColor = tetrominosColors[randomTetromino];
}
